...
//code # -1 没有错误 # 0 验证码错误 # 1 账号不为空 # 2 公司名称不为空 # 3 姓名不为空  # 4 手机不为空  # 5 密码不为空  # 6 两次密码不一致  # 7 账号已存在  # 8 公司已存在  # 9 账号不存在  # 10 密码错误 # 11 非法操作
...
var codeStr = ["验证码错误","邮箱不能为空","公司名称不能为空","姓名不能为空","手机号码不能为空","密码不能为空","两次密码不一致","邮箱已被注册","公司已被注册","账号不存在","密码错误","您的行为涉及他人信息安全"];
